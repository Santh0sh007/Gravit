...
### Android Build
To build and sync with the Android project:
```bash
...
- `static-serve`: Serve the `dist` folder using `serve`.
- `cap:sync`: Sync Capacitor project.
- `cap:open`: Open Android project in Android Studio.
- `build:android`: Build the web app and sync with Capacitor.
